const masterList = [
    ...
    {"name": "Hannah Z", "liveschoolName": "Alyssa Zihan Zhou", "house": "Red", "birthdate": "10-28-2008", "altName": "Hannah"},
    {"name": "Thomas", "liveschoolName": "Thomas Detong Zhu", "house": "Yellow", "birthdate": "2008-05-08", "altName": "Thomas"},

    //MS Band
    {"name": "Shine", "liveschoolName": "Shine Yu Duan", "house": "Blue", "birthdate": "2013-04-01", "altName": "Shine"},
    {"name": "Oscar", "liveschoolName": "Oscar Xinchen Fang", "house": "Red", "birthdate": "2013-04-01", "altName": "Oscar"},
    {"name": "Rebecca", "liveschoolName": "Rebecca Tsz Yin Cheung", "house": "Blue", "birthdate": "2013-04-01", "altName": "Rebecca"},
    {"name": "Andy", "liveschoolName": "Andy Xuanyu Feng", "house": "Green", "birthdate": "2013-04-01", "altName": "Andy"},
    {"name": "Grant", "liveschoolName": "Grant Zhang", "house": "Green", "birthdate": "2013-04-01", "altName": "Grant"},
    {"name": "Matthew", "liveschoolName": "Matthew Enhao Feng", "house": "Yellow", "birthdate": "2013-04-01", "altName": "Matthew"},
    {"name": "Nancy", "liveschoolName": "Nancy Han", "house": "Yellow", "birthdate": "2013-04-01", "altName": "Nancy"},
    {"name": "Grace X", "liveschoolName": "Grace Leqi Xiong", "house": "Red", "birthdate": "2013-04-01", "altName": "Grace--x"},
    {"name": "Celine", "liveschoolName": "Celine Yuting Shu", "house": "Blue", "birthdate": "2013-04-01", "altName": "Celine"},
    {"name": "Austen", "liveschoolName": "Austen Lihan Xie", "house": "Yellow", "birthdate": "2013-04-01", "altName": "Austen"},
    {"name": "Stella S", "liveschoolName": "Stella Yizhi Shang", "house": "Green", "birthdate": "2013-04-01", "altName": "Stella Shaong"},
    {"name": "Kyla", "liveschoolName": "Kyla Shi", "house": "Red", "birthdate": "2013-04-01", "altName": "Kyla"},
    {"name": "June", "liveschoolName": "June Ziqiao Qin", "house": "Blue", "birthdate": "2013-04-01", "altName": "June"},
    {"name": "Stella Y", "liveschoolName": "Stella Yuan", "house": "Yellow", "birthdate": "2013-04-01", "altName": "Stella Yunn"},
    {"name": "Grace N", "liveschoolName": "Grace Ning", "house": "Yellow", "birthdate": "2013-04-01", "altName": "Grace Ning"},
    {"name": "Anne", "liveschoolName": "Anne Jiayue An", "house": "Green", "birthdate": "2013-04-01", "altName": "Anne"},
    {"name": "Tyler", "liveschoolName": "Tyler Xiang Li", "house": "Red", "birthdate": "2013-04-01", "altName": "Tyler"},
    {"name": "Francis", "liveschoolName": "Francis Liu", "house": "Blue", "birthdate": "2013-04-01", "altName": "Francis"},
    {"name": "Owen", "liveschoolName": "Owen Qizhiyaun He", "house": "Green", "birthdate": "2013-04-01", "altName": "Owen"},
    {"name": "Zach", "liveschoolName": "Zachary Yang", "house": "Green", "birthdate": "2013-04-01", "altName": "Zach"},
    {"name": "Sophie", "liveschoolName": "Sophie Geng", "house": "Blue", "birthdate": "2013-04-01", "altName": "Sophie"},
    {"name": "Jacob", "liveschoolName": "Jacob I Chon He", "house": "Red", "birthdate": "2013-04-01", "altName": "Jacob"},
    {"name": "Jacky", "liveschoolName": "Jacky Tsz Hin Cheung", "house": "Green", "birthdate": "2013-04-01", "altName": "Jacky"},
    {"name": "Rene", "liveschoolName": "Rene King Hei Tang", "house": "Red", "birthdate": "2013-04-01", "altName": "Renee"},
    {"name": "Hannah C", "liveschoolName": "Hannah Ruihan Chen", "house": "Yellow", "birthdate": "2013-04-01", "altName": "Hannah"},
    {"name": "Aurora", "liveschoolName": "Aurora Yingxi Zhong", "house": "Yellow", "birthdate": "2013-04-01", "altName": "Aurora"},
...
const productionTechStudents = [
    'Fiona', 'Jimmy', 'Kevin', 'Mia', 'Howard', 'Vlan', 'Zoe', 'Voorhis', 'Ming Hon', 'Kiki', 'Yolanda', 'Stella L', 'Angel', 'Vincent', 'Edward', 'Diego', 'Chloe', 'Jerry', 'Alfred', 'Angelina', 'Howen', 'Tommy', 'Shawn', 'Isaac', 'Hannah Z', 'Thomas'
].map(name => {
...
const msBandStudents = [
   'Jacky', 'Oscar', 'Matthew', 'Nancy', 'Grace X', 'Stella Y', 'Grant', 'Anne', 'Hannah C', 'Rebecca', 'Shine', 'Andy', 'Sophie', 'Jacob', 'Owen', 'Tyler', 'Francis', 'Grace N', 'June', 'Stella S', 'Kyla', 'Celine', 'Rene', 'Austen', 'Zach', 'Aurora'
].map(name => {
    const studentInfo = masterList.find(s => s.name === name);
    return {
        name,
...
const msBandTeacherModeOrder = ['Shine', 'Oscar', 'Rebecca', 'Andy', 'Matthew', 'Grant', 'Jacky', 'Nancy', 'Grace X', 'Celine', 'Austen', 'Stella S', 'Kyla', 'Stella Y', 'Grace N', 'June', 'Tyler', 'Hannah C', 'Francis', 'Zach', 'Owen', 'Anne', 'Sophie', 'Jacob', 'Rene', 'Aurora'];




const msBandThursdayStudents = [
    'Anne', 'Hannah C', 'Rebecca', 'Shine', 'Andy', 'Sophie', 'Jacob', 'Owen', 'Tyler', 'Francis', 'Grace N', 'June', 'Stella S', 'Kyla', 'Celine', 'Rene', 'Austen', 'Zach', 'Aurora'
].map(name => {
    const studentInfo = masterList.find(s => s.name === name);
    return {
        name,
...
const msBandThursdayTeacherModeOrder = ['Shine', 'Rebecca', 'Andy', 'Celine', 'Austen', 'Stella S', 'Kyla', 'June', 'Grace N', 'Anne', 'Tyler', 'Francis', 'Owen', 'Zach', 'Sophie', 'Jacob', 'Rene', 'Hannah C', 'Aurora'];
